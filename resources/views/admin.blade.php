...
<head>
    ...
    <!-- Fonts and icons -->
    @vite(['resources/js/plugin/webfont/webfont.min.js'])
    ...
    <!-- CSS Files -->
    @vite(['resources/css/bootstrap.min.css', 'resources/css/plugins.min.css', 'resources/css/kaiadmin.min.css'])
...
<body>
    ...
    @vite(['resources/css/bootstrap.min.css', 
           ...
           'resources/js/core/jquery-3.7.1.min.js', 
